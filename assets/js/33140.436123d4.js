"use strict";(self.webpackChunk=self.webpackChunk||[]).push([["33140"],{67951:function(e,t,a){a.r(t),a.d(t,{conf:function(){return r},language:function(){return _}});var r={comments:{lineComment:"//",blockComment:["/*","*/"]},brackets:[["{","}"],["[","]"],["(",")"]],autoClosingPairs:[{open:"[",close:"]"},{open:"{",close:"}"},{open:"(",close:")"}],surroundingPairs:[{open:"{",close:"}"},{open:"[",close:"]"},{open:"(",close:")"}]};function n(e){let t=[],a=e.split(/\t+|\r+|\n+| +/);for(let e=0;e<a.length;++e)a[e].length>0&&t.push(a[e]);return t}var o=n("true false"),i=n(`
			  alias
			  break
			  case
			  const
